...
@section ('title', app_name() . ' | ' . __('labels.backend.subjects.edit'))
...
@section('content')
    {{ html()->modelForm($subject, 'PATCH', route('admin.subject.update', $subject))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.subjects.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
