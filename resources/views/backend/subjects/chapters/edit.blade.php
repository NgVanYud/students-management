...
@section ('title', app_name() . ' | ' . __('labels.backend.subjects.chapters.edit'))
...
@section('content')
    {{ html()->modelForm($chapter, 'PATCH', route('admin.subject.chapter.update', [$subject, $chapter]))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.subjects.chapters.edit') }}</small>
                    </h4>
                    <h5 class="mt-2">
